        ...
        <section id="inicio">
          <div className="animate-slideleft">
            ...
            <p className="text-lg text-center text-white mx-60">
              ...
              estudiantes entendemos que es posible que enfrente muchos desafíos
              que pueden afectar su bienestar. Nuestro chatbot ofrece una gama
              de funcionalidades para ayudarle a gestionar estos desafíos.
            </p>
          </div>
          <Image
            src="/chatbot.png"
            ...
            width={1050}
            height={900}
            className="animate-appearAbove mx-auto mt-20"
          />
        </section>
        ...
        <section id="funcionalidades">
          ...
          >
            ...
            <div className="col-span-1 row-span-1 grid justify-items-center  py-6 px-2 bg-[#7471D9] hover:bg-[#AAA7F2] hover:text-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <p className="mb-3 font-normal ">
                Ejercicios creativos y personalizados para ayudarle a mantener
          ...
          <section className="flex flex-row mx-8">
            <div id="como" className="grid place-items-center w-3/6">
              <h1 className="text-3xl font-bold ">
                <a href="#top"> Como Funciona </a>{" "}
              </h1>
              <p className="mx-12">
                Nuestro chatbot esta basado en inteligencia artificial y usa
                ejercicios basados en la evidencia y recursos para ayudarte a
                manejar tu ansiedad y estrés. Nuestro chatbot esta diseñado para
                ...
                contigo con técnicas terapeúticas comprobadas, incluído un
                senguimiento de tu ánimo y tu estado emocional consciente.
              </p>
            </div>
