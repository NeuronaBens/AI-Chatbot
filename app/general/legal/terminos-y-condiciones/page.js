export default function Terminos() {
  return (
    <div className="bg-white my-8 max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <h2 className="text-xl font-bold mb-2">3. Capacidad</h2>
      <p className="mb-4">
        Podrán utilizar nuestros servicios las personas mayores de edad que
        tengan capacidad legal para hacerlo.
      </p>

      <h2 className="text-xl font-bold mb-2">4. Registro y Cuenta</h2>
      <p className="mb-4">
        Para utilizar nuestros servicios, las Personas Usuarias deben completar
        el formulario de registro con información precisa y mantener sus datos
        actualizados. La cuenta es personal e intransferible, y la Persona
      ...
      <p className="mb-4">
        Estos Términos y Condiciones se rigen por la ley peruana. Cualquier
        controversia será resuelta por tribunales competentes en la capital, a
