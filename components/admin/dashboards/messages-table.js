      ...
      <Table className="table-auto table-fixed bg-white">
        <Thead>
          <Tr>
            ...
            <Th className="px-4 py-2 w-1/12 bg-orange-300">Session</Th>
            <Th className="px-4 py-2 w-1/12 bg-orange-300">Position</Th>
        ...
        <Tbody>
          {messages.map((message) => (
            <Tr key={message.id} className="hover:bg-orange-100">
              ...
              <Td className="border px-4 py-2 text-left">{message.session}</Td>
              <Td className="border px-4 py-2 text-left">{message.position}</Td>
